...
def nanodet_nms(prediction, conf_thres=0.25, iou_thres=0.45, classes=None, agnostic=False, max_det=300):
    """Runs Non-Maximum Suppression (NMS) on inference results
    prediction: (N, num_obj, xyxy+num_classes)
...
def non_max_suppression(prediction, conf_thres=0.25, iou_thres=0.45, classes=None, agnostic=False, max_det=300):
    """Runs Non-Maximum Suppression (NMS) on inference results
    prediction: (N, num_obj, xyxy+objectness+num_classes)
